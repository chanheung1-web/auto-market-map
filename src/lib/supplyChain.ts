...
export const SUPPLY_CATEGORIES: SupplyCategory[] = [
  {
    ...
    players: [
      ...
      { rank: 3, name: "POSCO", hq: "🇰🇷 韓国", share: "~7%", sharePercent: 7, shareNote: "鉄鋼3位", products: "ギガスチール・PosH系", strategy: "Hyundai向け供給強み", note: "H-型鋼・冷延鋼板幅広く展開", companyId: "posco" },
      { rank: 4, name: "ThyssenKrupp", hq: "🇩🇪 ドイツ", share: "~6%", sharePercent: 6, shareNote: "鉄鋼4位", products: "プレス成形用高張力鋼", strategy: "欧州OEM向け鋼材", note: "スチールサービスセンター機能", companyId: "thyssenkrupp" },
      { rank: 5, name: "SSAB", hq: "🇸🇪 スウェーデン", share: "~4%", sharePercent: 4, shareNote: "鉄鋼5位", products: "Hardox耐摩耗鋼板", strategy: "グリーンスチール (HYBRIT)先行", note: "CO2フリー鋼材開発で注目", companyId: "ssab" },
    ],
  },
  {
    id: "c2-metalアルミ",
    ...
    source: "automotive_supply_chain_v2.xlsx（2024年基準・調査会社推計）",
    players: [
      { rank: 1, name: "Novelis (Hindalco子会社)", hq: "🇮🇳/🇺🇸", share: "~18%", sharePercent: 18, shareNote: "圧延首位", products: "圧延アルミ (ボディシート全般)", strategy: "リサイクルアルミ戦略・低炭素", note: "自動車向け圧延アルミ世界No.1", companyId: "hindalco" },
      { rank: 2, name: "Constellium SE", hq: "🇳🇱 オランダ", share: "~12%", sharePercent: 12, shareNote: "圧延2位", products: "アルミ構造材・BIW部品", strategy: "Tesla/BMW長期供給契約", note: "CES 2024で新世代アルミ構造体発表", companyId: "constellium" },
      { rank: 3, name: "Norsk Hydro", hq: "🇳🇴 ノルウェー", share: "~10%", sharePercent: 10, shareNote: "総合3位", products: "押出・圧延・鋳造全般", strategy: "グリーンアルミ・低炭素製品", note: "垂直統合型。Porscheとグリーンアルミ提携", companyId: "norsk-hydro" },
      ...
      { rank: 5, name: "UACJ Corporation", hq: "🇯🇵 日本", share: "~6%", sharePercent: 6, shareNote: "鋳造5位", products: "アルミ圧延・鋳造", strategy: "日系OEM向け安定供給", note: "三菱マテリアル・住友軽金属合併", companyId: "uacj" },
    ],
  },
  {
    id: "c3-シャシー-サスペンション",
    ...
    players: [
      ...
      { rank: 3, name: "Gestamp Automoción", hq: "🇪🇸 スペイン", share: "~8%", sharePercent: 8, shareNote: "シャシー2位", products: "ホットスタンプ成形部品・Bピラー", strategy: "超高張力鋼プレス成形技術", note: "欧州・中国・北米に幅広く展開", companyId: "gestamp" },
      ...
      { rank: 5, name: "KYB Corporation", hq: "🇯🇵 日本", share: "~6%", sharePercent: 6, shareNote: "サスペンション3位", products: "油圧ダンパー・ショックアブソーバ", strategy: "日系OEM向けに高いシェア", note: "世界シェアサスペンション系で安定", companyId: "kyb" },
    ],
  },
  {
    id: "c4-シール-ウェザーストリップ",
    ...
    source: "automotive_supply_chain_v2.xlsx（2024年基準・調査会社推計）",
    players: [
      { rank: 1, name: "Cooper Standard", hq: "🇺🇸 米国", share: "~20%", sharePercent: 20, shareNote: "首位", products: "Weatherstrip全般・Glass run・Fortrex素材", strategy: "EV向け軽量NVHシール・低摩擦素材", note: "北米/欧州/APACに全球展開", companyId: "cooper-standard" },
      ...
      { rank: 4, name: "Nishikawa Rubber (西川ゴム)", hq: "🇯🇵 日本", share: "~10%", sharePercent: 10, shareNote: "4位", products: "ドアシール・Glass run全般", strategy: "日系OEM向け安定供給", note: "広島本社。マツダ・ホンダに強み", companyId: "nishikawa-rubber" },
  ...
  },
  {
    ...
    players: [
      ...
      { rank: 2, name: "Bridgestone", hq: "🇯🇵 日本", share: "~14%", sharePercent: 14, shareNote: "タイヤ2位", products: "Potenza・Turanza・Blizzak", strategy: "EV対応タイヤ・ランフラット技術", note: "収益の約90%がタイヤ事業", companyId: "bridgestone" },
      ...
      { rank: 4, name: "Goodyear", hq: "🇺🇸 米国", share: "~8%", sharePercent: 8, shareNote: "タイヤ4位", products: "Eagle F1・Assurance・Wrangler", strategy: "自動運転対応センサータイヤ開発", note: "北米で特に強い市場地位", companyId: "goodyear" },
      { rank: 5, name: "Pirelli", hq: "🇮🇹 イタリア", share: "~5%", sharePercent: 5, shareNote: "タイヤ5位", products: "Pゼロ・Cinturato プレミアム特化", strategy: "F1・高性能ハイエンド特化戦略", note: "中国ChemChina(化工集団)系", companyId: "pirelli" },
    ],
  },
  {
    id: "c6-樹脂素材",
    ...
    source: "automotive_supply_chain_v2.xlsx（2024年基準・調査会社推計）",
    players: [
      { rank: 1, name: "BASF SE", hq: "🇩🇪 ドイツ", share: "~12%", sharePercent: 12, shareNote: "首位", products: "Ultramid(PA)・Ultradur(PBT)・Elastollan", strategy: "バイオマスバランス対応グリーン樹脂", note: "自動車向けエンプラで業界No.1", companyId: "basf" },
      { rank: 2, name: "SABIC (Saudi Aramco系)", hq: "🇸🇦 サウジ", share: "~10%", sharePercent: 10, shareNote: "2位", products: "PP・PC・エンプラ全般 BLUEHERO™", strategy: "EV向け難燃電池ケース素材強化", note: "世界最大規模の石化企業の一つ", companyId: "sabic" },
      { rank: 3, name: "LyondellBasell", hq: "🇳🇱 オランダ", share: "~9%", sharePercent: 9, shareNote: "3位", products: "PP (Hifax/Schulamid) 世界最大手", strategy: "低VOC内装材・再生PP対応", note: "PPで世界最大の供給力を持つ", companyId: "lyondellbasell" },
      { rank: 4, name: "Covestro AG", hq: "🇩🇪 ドイツ", share: "~8%", sharePercent: 8, shareNote: "4位", products: "ポリカーボネート(PC)・PU全般", strategy: "リサイクルPC (Makrolon RP)", note: "グレーズィング・LEDカバーに強み", companyId: "covestro" },
      { rank: 5, name: "DuPont / Zytel", hq: "🇺🇸 米国", share: "~6%", sharePercent: 6, shareNote: "5位", products: "ナイロン(PA)・高耐熱樹脂 Zytel", strategy: "EV向けコネクタ周辺高耐熱素材", note: "電装周辺樹脂・自動車構造部材に強み", companyId: "dupont" },
    ],
  },
  {
    id: "c7-シート",
    ...
    source: "automotive_supply_chain_v2.xlsx（2024年基準・調査会社推計）",
    players: [
      { rank: 1, name: "Adient PLC", hq: "🇮🇪/🇺🇸", share: "~22%", sharePercent: 22, shareNote: "首位", products: "シートフレーム・フォーム・表皮全般", strategy: "EV向け軽量化・リサイクル素材シート", note: "旧Johnson Controls シート部門", companyId: "adient" },
  ...
  },
  {
    ...
    players: [
      ...
      { rank: 4, name: "Yanfeng Automotive", hq: "🇨🇳 中国", share: "~10%", sharePercent: 10, shareNote: "4位", products: "ダッシュボード・インパネ・内装全般", strategy: "中国EV向けに急成長", note: "旧JCI・延鋒。中国系でグローバル展開", companyId: "yanfeng-hasco" },
  ...
  },
  {
    ...
    players: [
      ...
      { rank: 3, name: "NSG (Pilkington)", hq: "🇯🇵 日本", share: "~18%", sharePercent: 18, shareNote: "ガラス3位", products: "ウィンドシールド・HUD対応ガラス", strategy: "GM・Cadillac HUDウィンドシールド採用", note: "旧英Pilkingtonを日本板硝子が買収", companyId: "nsg" },
      { rank: 4, name: "Saint-Gobain Sekurit", hq: "🇫🇷 フランス", share: "~14%", sharePercent: 14, shareNote: "ガラス4位", products: "ルーフガラス・バックライト全般", strategy: "GLASSDRIVEでウィンドシールドリサイクル", note: "Saint-Gobainの自動車ガラス部門", companyId: "saint-gobain" },
  ...
  },
  {
    ...
    players: [
      ...
      { rank: 4, name: "Furukawa Electric (古河電工)", hq: "🇯🇵 日本", share: "~8%", sharePercent: 8, shareNote: "4位", products: "自動車電線・光電複合ハーネス", strategy: "光通信技術活用の次世代ハーネス", note: "日系OEM向け電線・ハーネス", companyId: "furukawa-electric" },
  ...
  },
  {
    ...
    players: [
      ...
      { rank: 5, name: "Visteon Corporation", hq: "🇺🇸 米国", share: "~8% (IVI)", sharePercent: 8, shareNote: "IVI5位", products: "デジタルコックピット・クラスターシステム", strategy: "NVIDIA/NXP連携でソフト差別化", note: "非常に多くのOEMにクラスター供給", companyId: "visteon" },
    ],
  },
  {
    id: "c12-mcu",
  ...
  },
  {
    ...
    players: [
      ...
      { rank: 4, name: "Wolfspeed", hq: "🇺🇸 米国", share: "~12%", sharePercent: 12, shareNote: "SiC材料No.1", products: "SiC基板・デバイス", strategy: "8インチSiCウエハ先行者優位", note: "世界最大のSiC基板サプライヤー", companyId: "wolfspeed" },
  ...
  },
  {
    ...
    players: [
      ...
      { rank: 5, name: "OmniVision Technologies", hq: "🇺🇸 米国(中国系)", share: "~20% (センサー)", sharePercent: 20, shareNote: "センサー2位", products: "車載用CMOSイメージセンサー", strategy: "コスト競争力・中国勢向け採用", note: "Sony対抗でコスト訴求", companyId: "will-semi" },
    ],
  },
  {
    id: "c15-塗料-コーティング",
    ...
    source: "automotive_supply_chain_v2.xlsx（2024年基準・調査会社推計）",
    players: [
      { rank: 1, name: "PPG Industries", hq: "🇺🇸 米国", share: "~15%", sharePercent: 15, shareNote: "首位", products: "OEM塗料・補修塗料・電着塗料全般", strategy: "BYD協業・中国EV向け特殊効果色", note: "150以上の製造拠点。グローバル最強", companyId: "ppg" },
      { rank: 2, name: "BASF Coatings", hq: "🇩🇪 ドイツ", share: "~12%", sharePercent: 12, shareNote: "2位", products: "CathoGuard電着塗料・iGloss系クリア", strategy: "バイオマスバランス対応塗料展開", note: "化学大手のコーティング部門", companyId: "basf" },
      { rank: 3, name: "Axalta Coating Systems", hq: "🇺🇸 米国", share: "~11%", sharePercent: 11, shareNote: "3位", products: "Spies Hecker・Standox補修ブランド", strategy: "デジタルスプレー技術 (Xaar連携)", note: "旧DuPont塗料部門。補修塗料世界有数", companyId: "axalta" },
      { rank: 4, name: "AkzoNobel", hq: "🇳🇱 オランダ", share: "~10%", sharePercent: 10, shareNote: "4位", products: "Sikkens・Lesonal補修塗料", strategy: "Autowave Optima 水性ベースコート", note: "関西ペイント欧州事業買収で拡大", companyId: "akzonobel" },
      { rank: 5, name: "Nippon Paint Holdings", hq: "🇯🇵 日本(Wuthelam系)", share: "~8%", sharePercent: 8, shareNote: "5位", products: "OEM塗料・自動車補修アジア首位", strategy: "アジア・中国市場でPPGに対抗", note: "Wuthelam Groupが筆頭株主", companyId: "nippon-paint" },
    ],
  },
];
